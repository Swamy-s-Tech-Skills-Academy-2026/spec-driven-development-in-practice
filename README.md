...
- It is **not a formal course or authoritative source**
...
Notes live under **`src/notes/`**; other topic folders and **`docs/`** are at the repository root (see
...
- Evaluation-driven architectures
