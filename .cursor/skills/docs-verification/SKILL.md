...
| Internal-only material | `.cursor/rules/06_source_material_rules.mdc` | Naming `source-material/` or `reference-material/` in `README.md`, `src/notes/`, root topic folders, or `docs/**/*.md` |
...
| Topic content | `src/notes/`, `specs/`, `evals/`, `patterns/`, `experiments/` (as present) |
