...
| Topic folders | `.cursor/rules/09_week-companion-architecture.mdc` | Wrong folder for content type (e.g. spec content under `notes/` when it belongs in `specs/`) |
...
| Topic content | `notes/`, `specs/`, `evals/`, `patterns/`, `experiments/` (as present) |
